...
router.get("/category-products/:categoryId", verifyLoggedIn, async (request, response) => {
    try {
...
router.post("/", [verifyAdmin,verifyLoggedIn], async (request, response) => {
    try {
...
router.delete("/:id", [verifyAdmin,verifyLoggedIn], async (request, response) => {
    try {
        const id = request.params.id;
...
router.patch("/:_id", [verifyAdmin,verifyLoggedIn], async (request, response) => {
    try {
